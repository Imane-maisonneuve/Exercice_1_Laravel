                ...
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            ...
                            <div class="col-lg-8">
                                <div>
                                    Developed and maintained multiple high-traffic web applications using modern frameworks like Laravel and React. Implemented responsive designs and optimized performance, resulting in a 30% increase in page speed and user engagement.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            ...
                            <div class="col-lg-8">
                                <div>
                                    Managed search engine marketing campaigns for multiple clients, improving organic traffic by 45% and reducing ad spend by 20%. Conducted keyword research, A/B testing, and performance analysis to optimize campaigns.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            ...
                            <div class="col-lg-8">
                                <div>
                                    Completed a Master's degree in Web Development, focusing on full-stack development, responsive design, and advanced JavaScript frameworks. Developed multiple projects including e-commerce platforms and web applications for startups.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            ...
                            <div class="col-lg-8">
                                <div>
                                    Earned a Bachelor's degree in Computer Science with a focus on software engineering, data structures, and algorithms. Completed internships and practical projects in web development and application design.
                                </div>
                            </div>
                        </div>
                    </div>
